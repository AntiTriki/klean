...
//$i++;
//   }
$result = mysql_query("select d.id as id, c.nombre as codigo,   d.cantidad as debe, c.precio_venta as haber
from 
articulo c , detalle_nota d, nota_venta co
where
c.id=d.id_articulo and d.id_nota=co.id and co.id=$qid");
